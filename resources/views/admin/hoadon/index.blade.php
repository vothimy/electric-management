	...
	<div class="forms-main">
		...
		<div class="graph-form">
			<div class="validation-form">
				<form action="{{ route('admin.hoadon.show') }}" method="POST">
				{{csrf_field()}}
					
					<div class="vali-form">
						<div class="col-md-6 form-group1">
							<label class="control-label">Xã</label>
							<select name="selector1" id="selector3"  class="form-control">
								<option>--xã---</option>
								@foreach($arX as $arx)
						...
						<div class="col-md-6 form-group1">
							...
							<select name="selector2" id="selector4" class="form-control">
								<option>---thôn--</option>
								@foreach($arT as $art)
