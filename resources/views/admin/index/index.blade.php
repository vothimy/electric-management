	...
	<div class="candile"> 
		<div class="candile-inner">
			...
			<div id="center"><div id="fig">
				...
				<script type="text/javascript" src="{{$adminUrl}}/js/protovis-d3.2.js"></script>
				<script type="text/javascript" src="{{$adminUrl}}/js/vix.js"></script>
	...
	<div class="chrt-inner">
		<div class="chrt-bars">
			<div class="col-md-6 chrt-two">
				...
				<div id="chart2"></div>
				<script src="{{$adminUrl}}/js/fabochart.js"></script>
				<script>
		...
		<div class="area">
			<div class="col-md-6 chrt-two area">
				...
				<script src="{{$adminUrl}}/js/Chart.js"></script>
			</div>
			<div class="col-md-6 chrt-three">
				...
				<div class="profile-nav alt">
					<section class="panel">
						...
						<ul class="clock-category">
							<li>
								<a href="#" class="active">
									<img src="{{$adminUrl}}/images/time.png" alt="">
									<span>Clock</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="{{$adminUrl}}/images/alarm.png" alt="">
									<span>Alarm</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="{{$adminUrl}}/images/watch.png" alt="">
									<span>Stop watch</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="{{$adminUrl}}/images/timer.png" alt="">
									<span>Timer</span>
								</a>
							</li>
						</ul>
