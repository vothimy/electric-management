...
<style>
    ...
    <!--=== Breadcrumbs ===-->
		<div class="breadcrumbs">
			<div class="container">
				<h1 class="pull-left"><span id="ContentPlace_lbTieude">Yêu cầu di dời công tơ</span></h1>
				<ul id="ContentPlace_breadcumbs" class="pull-right breadcrumb">
					...
					<li class='active'>Yêu cầu di dời công tơ</li>
				</ul>
			</div>
		</div><!--/breadcrumbs-->
		<!--=== End Breadcrumbs ===-->
				            ...
				            <div class="tab-content" style="background:white;border:none">
					            <div class="form-horizontal" >
					                <div class="form-group">
	                                    ...
	                                    <div class="col-lg-5">
		                                    <input name="ctl00$ContentPlace$lbMakh" type="text" id="ContentPlace_lbMakh" disabled="disabled" class="aspNetDisabled form-control color-blue" />
	                                    </div>
                                    </div>
                                    <div class="form-group">
	                                    <label class="col-lg-3 control-label">Tên Khách hàng</label>
	                                    <div class="col-lg-5">
		                                    <input name="ctl00$ContentPlace$lbTenKH" type="text" id="ContentPlace_lbTenKH" disabled="disabled" class="aspNetDisabled form-control color-blue" />
	                                    </div>
                                    </div>
                                    <div class="form-group">
	                                    <label class="col-lg-3 control-label">Địa chỉ</label>
	                                    <div class="col-lg-5">
		                                    <input name="ctl00$ContentPlace$lbDiachi" type="text" id="ContentPlace_lbDiachi" disabled="disabled" class="aspNetDisabled form-control color-blue" />
	                                    </div>
                                    </div>
                                    <div class="form-group">
		...
		<option value="KHAC">Kh&#225;c</option>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Lý do đề nghị di dời công tơ</label>
	                                    <div class="col-lg-5">
		                                    <textarea name="ctl00$ContentPlace$ghichu" rows="3" cols="20" id="ContentPlace_ghichu" class="form-control color-blue" placeholder="Nhập lý do đề nghị di dời công tơ.." style="width:100%;resize:vertical;">
</textarea>
	                                    </div>
                                    </div>
                                    <br />
